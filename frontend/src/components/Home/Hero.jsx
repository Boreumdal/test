...
const Hero = () => {
  ...
  return (
    <div className='bg-white h-[80vh] border flex flex-col items-center justify-center'>
        ...
        { token && <Link to='/dashboard' className='mt-5 border-2 border-green-500 hover:bg-green-500 hover:text-white text-green-500 hover:bg-transparent py-1 px-3 rounded font-semibold duration-300 shadow-sm'>Dashboard</Link> }
    </div>
  )
}
